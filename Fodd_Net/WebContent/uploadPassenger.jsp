      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 pr-md-5">
            ...
            <h3> <font color='red'><b><u>Passenger Details:</u></b></font></h3><br/>
                  <div class="row">
                  
                    <div class="col-md-4 form-group">
                      <label for="email">Select Taxi</label>
                      <select class="form-control py-2" name="taxiId" required>
                      <%
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <select name="source" class="form-control py-2" required>
                      <%
                    ...
                    <div class="col-md-4 form-group">
                      <label for="email">Destinatin Location</label>
                      
                      <select name="destination" class="form-control py-2" required>
                      <%
                      if(!li.isEmpty() && li.size()>0)
                      {
                      for(String str:li)
                     ...
                     <div class="col-md-4 form-group">
                      ...
                      <input type="text" name="pickup" placeholder="09:10 AM" class="form-control py-2" required>
                    </div>
