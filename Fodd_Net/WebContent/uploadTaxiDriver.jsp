      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 pr-md-5">
            ...
            <h3> <font color='red'><b><u>Taxi Driver Details:</u></b></font></h3><br/>
                  <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <input type="text" name="pickUp"  placeholder="10:10" class="form-control py-2" required>
                    </div>
                      <div class="col-md-4 form-group">
                      <label for="email">Drop Time</label>
                      <input type="text" name="dropTime"  placeholder="14:10" class="form-control py-2" required>
                    </div>
                  </div>
