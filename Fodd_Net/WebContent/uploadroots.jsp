      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 pr-md-5">
            <form action="UploadRoot" method="get" enctype="multipart/form-data"><h3> <font color='red'><b><u>Upload Root Details:</u></b></font></h3><br/>
            
                  <div class="row">
                   
                    <div class="col-md-4 form-group">
                    <input type="hidden" id="p" name="p" value="1"/>
                      <label for="email">Starting Location</label>
                        <input type="text" id="point" name="starting" value="" required/>


						<div id="kids">
							Point 1:
							<table>
							<tr><td><input type="text" name="point_1" style="height: 40px;" required></td>
							<td><input type="button" id="add_kid()_1" class="btn btn-success" style="height: 40px;" onclick="addkid()" value="+" /></td>
							</tr>
							</table>
						 ...
						 <label for="email">Ending Location</label>
                        <input type="text" id="point" name="ending" value="" required/>
                    </div>
