...
<jsp:include page="header.jsp"></jsp:include>    <!-- END section -->
              ...
              <div class="col-md-12 col-lg-6 mb-5">
                <div class="block-19">
                  <figure>
                    ...
                    <a href="course-single.html"><img src="image.jsp?val=<%=i%>" alt="Image"  height="230" width="295" ></a>
                  </figure>
                    <div class="text">
                      <h2 class="heading">
                      <a   href=""><%= rb.getRestaurantName()%>
									</a></h2>
                     ...
                     <%=rb.getLocation() %></p>
                      <div class="meta d-flex align-items-center">
                        ...
                        <div class="price text-right"><del class="mr-3"></del>
                        
                        <a href="customerOrder.jsp?id=<%=rb.getId() %>&name=<%=rb.getRestaurantName() %>&food=<%=rb.getFood() %>&location=<%=rb.getLocation() %>&price=<%=rb.getPrice() %>"><span>Order</span></a>
			...
			<div class="modal-content">
				...
				<form action="./AdminAcceptOrder" method="get"
					...
					<div class="modal-body">
						...
						<font color="blue"><b>Restaurant Name</b></font> <br> 
						<input type="text" name="name" id="na" class="form-control" readonly="readonly"/><br/>
						
						<font color="blue"><b>Restaurant Location</b></font> <br> 
						<input type="text" name="location" id="lo" class="form-control" readonly="readonly"/><br/>
						
						
						<font color="blue"><b>User Location</b></font> <br> 
						<input type="text" name="location" id="lo" class="form-control" required/><br/>
