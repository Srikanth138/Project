...
<%@page import="java.util.Set"%><jsp:include page="header.jsp"></jsp:include>
    ...
    <section class="site-section element-animate">
      <div class="container">
			...
			{
			 %>
			<td><a href="ViewAvailableTaxis.jsp?i=<%=i %>"><button type="buttong" class="btn btn-success btn-sm">Available</button></a></td><%
			}
			else
			{
			 %>
			<td><a href="createOwnTaxi.jsp?i=<%=i %>"><button type="buttong" class="btn btn-danger btn-sm">Own Vehicle</button></a></td><%
			}
			 %>
			</tr>
			<%
